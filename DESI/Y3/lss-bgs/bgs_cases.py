...
PRE_N_LOOPS = {
    "BGS_BRIGHT-21.5": {(0.1, 0.4): {"SGC": 2048, "NGC": 1024}},
    "BGS_ANY-21.35": {
        (0.1, 0.4): {"SGC": 3072, "NGC": 1024},
        (0.25, 0.4): {"SGC": 4096, "NGC": 1536},
    },
    "BGS_BRIGHT-21.35": {
        (0.1, 0.4): {"SGC": 3072, "NGC": 1024},
        (0.0, 0.3): {"SGC": 3072, "NGC": 1536},
        (0.25, 0.4): {"SGC": 4096, "NGC": 1536},
    },
    "BGS_BRIGHT+FAINT-21.35": {
        (0.1, 0.4): {"SGC": 3072, "NGC": 1024},
        (0.0, 0.3): {"SGC": 3072, "NGC": 1536},
        (0.3, 0.5): {"SGC": 4096, "NGC": 1536},
    },
    "BGS_BRIGHT+FAINT-20.7": {
        (0.0, 0.3): {"SGC": 9216, "NGC": 4608},
        (0.3, 0.5): {"SGC": 3072, "NGC": 1536},
    },
    "BGS_BRIGHT-20.2": {
        (0.1, 0.25): {"SGC": 4096, "NGC": 2048},
        (0.1, 0.4): {"SGC": 1024, "NGC": 512},
    },
}

POST_N_LOOPS = {
    "BGS_BRIGHT-21.5": {(0.1, 0.4): {"SGC": 3072, "NGC": 1536}},
    "BGS_ANY-21.35": {
        (0.1, 0.4): {"SGC": 3072, "NGC": 1536},
        (0.25, 0.4): {"SGC": 3072, "NGC": 1536},
    },
    "BGS_BRIGHT-21.35": {
        (0.1, 0.4): {"SGC": 3072, "NGC": 1536},
        (0.0, 0.3): {"SGC": 3072, "NGC": 1536},
...
def get_n_loops(phase, tracer, zrange, region, default=None, allow_missing=False):
    loops = {"pre": PRE_N_LOOPS, "post": POST_N_LOOPS}[phase]
    zrange = normalize_zrange(zrange)
    try:
