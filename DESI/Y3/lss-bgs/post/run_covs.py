...
n_loops = {'BGS_BRIGHT-21.5': {(0.1, 0.4): {'SGC': 3072,
                                            'NGC': 1536}},
           ...
           'BGS_BRIGHT+FAINT-21.35': {(0.1, 0.4): {'SGC': 3072,
                                      ...
                                      (0.3, 0.5): {'SGC': 3072,
                                                   'NGC': 1536}},
           'BGS_BRIGHT+FAINT-20.7': {(0, 0.3): {'SGC': 9216,
                                                'NGC': 4608},
                                     (0.3, 0.5): {'SGC': 3072,
                                                  'NGC': 1536}},
...
outdir_base = os.path.join(verspec, version, args.compmd, conf, recon_spec, "_".join(tlabels + [reg]) + f"_z{z_min}-{z_max}")
