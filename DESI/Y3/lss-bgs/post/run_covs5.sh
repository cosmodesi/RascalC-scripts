...
#SBATCH --job-name=RascalC-LSS-BGS-recon_nonkp_z0p3_0p45_bright_bf_21p35
...
#SBATCH --array=0-1 # nonkp_z0p3_0p45_bright_bf_21p35 relaunch
...
python -u run_covs.py $SLURM_ARRAY_TASK_ID --campaign nonkp_z0p3_0p45_bright_bf_21p35
