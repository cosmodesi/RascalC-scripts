...
#SBATCH --job-name=RascalC-LSS-BGS-recon_nonkp_bright_compare
...
#SBATCH --array=7-9 # nonkp_bright_compare re-run
...
python -u run_covs.py $SLURM_ARRAY_TASK_ID --campaign nonkp_bright_compare
