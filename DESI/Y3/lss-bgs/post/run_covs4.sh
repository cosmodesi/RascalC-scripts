...
#SBATCH --job-name=RascalC-LSS-BGS-recon_nonkp_meeting_20260521_bright20p7
...
#SBATCH --array=0 # re-run nonkp_meeting_20260521_bright20p7
...
python -u run_covs.py $SLURM_ARRAY_TASK_ID --campaign nonkp_meeting_20260521_bright20p7
