### Python script for running RascalC in DESI setup (Michael Rashkovetskyi, 2024-2025).
import sys, os
import numpy as np
...
parser = argparse.ArgumentParser(description = "Main RascalC computation script for DESI Y3 post-recon two-tracer")
...
outdir_base = os.path.join(verspec, version, conf, recon_spec, "_".join(list(tlabels) + [reg]) + f"_z{z_min}-{z_max}")
