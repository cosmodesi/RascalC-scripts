...
parser = argparse.ArgumentParser(description = "Main RascalC computation script for DESI Y3 Uchuu mocks post-recon single-tracer")
...
z_min, z_max = z_range
nrandoms = {'LRG': 4, 'ELG_LOPnotqso': 5, 'QSO': 4}[tlabels[0]]
